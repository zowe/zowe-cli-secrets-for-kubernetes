...
export class TestEnvironment {
     ...
     */
    public static async installPlugin(testEnvironment: ITestEnvironment) {
        ...
        installScript += "zowe plugins validate " + this.PLUGIN_NAME + "\n";
        ...
        if (output.status !== 0) {
            testEnvironment.pluginInstalled = false;
            throw new ImperativeError({
                msg: "Install of '" + this.PLUGIN_NAME + "' plugin failed! You should delete the script: \n'" + scriptPath + "' " +
        ...
        testEnvironment.pluginInstalled = true;
    ...
    private static readonly PLUGIN_NAME = "@zowe/secure-credential-store-for-zowe-cli";
